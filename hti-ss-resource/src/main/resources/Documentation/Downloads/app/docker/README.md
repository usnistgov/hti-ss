# Docker NIST Sydromic Test Suite Edition 2 Deployment Guide
...
2. Locate the `hti-ss-svap-tomcat:image` property
3. Change the image link from `nist775hit/hti-ss-svap-tool:latest` to `nist775hit/hti-ss-svap-tool:TOOLVERSION`
4. Save the file
