...
package gov.nist.healthcare.hl7.v2.ss.tool.test.groovy.integration;
...
@Configuration
@EnableJpaRepositories("gov.nist.healthcare.hl7.v2.ss.tool.repo")
...
public class TestDbConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		lef.setPackagesToScan("gov.nist.healthcare.hl7.v2.ss.tool.domain");
